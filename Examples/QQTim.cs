...
namespace Examples
{
    class QQTim
    {
        ...
        public QQTim()
        {
            appSilmulateInfo = FileDataLoader.GetCombined("qqtim");
        ...
        private AppSilmulateInfo DefualtConfig()
        {
            ...
            {
                FileName = "C:\\Program Files (x86)\\Tencent\\TIM\\Bin\\QQScLauncher.exe",
                MainWindowFileName = "C:\\Program Files (x86)\\Tencent\\TIM\\Bin\\TIM.exe",
                MainWindowTitle = "TIM"
            };
